...
from utils.model_utils import check_dir, train_network, eval_network, network_report, network_outer_report
from utils.experiment_utils import train_tml_model_nested_cv, predict_final_test, \
    train_networt_less_points, plot_num_points_exp, plot_results, explain_model
...
def train_networt_nested_cv():
    ...
    if check_dir(f"{current_dir}/{opt.log_dir_results}/{opt.exp_name}/results_GNN") and opt.run_gnn_training:
